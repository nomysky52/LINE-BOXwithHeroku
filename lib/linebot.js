...
class LineBot extends EventEmitter {
        ...
        body.events.forEach(function(event) {
            ...
            if (event.source) {
                ...
                event.source.member = function() {
                    ...
                    return console.log('event source.type : '+event.source.type);
                };
    ...
    // 取得追蹤成員
    getFollowers() {
        const url = `/followers/ids`;
        return this.get(url).then(res => res.json()).then((followers) => {
    ...
    getGroupProfile(groupId) {
        ...
        return this.get(url).then(res => res.json()).then((group) => {
    ...
    getGroupMemberProfile(groupId, userId) {
        ...
        return this.get(url).then(res => res.json()).then((groupMemberProfile) => {
            console.log('groupMemberProfile : ' + JSON.stringify(groupMemberProfile));
            groupMemberProfile.groupId = groupId;
    ...
    getRoomMemberProfile(roomId, userId) {
        ...
        return this.get(url).then(res => res.json()).then((roomMemberProfile) => {
            console.log('roomMemberProfile : ' + JSON.stringify(roomMemberProfile));
            roomMemberProfile.roomId = roomId;
